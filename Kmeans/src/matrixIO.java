...
public class matrixIO {
    ...
    static final String DEV_INPUT_PATH = "data/Hdev.docVectors";
    static final String TEST_INPUT_PATH = "data/test.docVectors";
    static final String DEV_OUT_PATH = "data/dev.clusters";
    static final String TEST_OUT_PATH = "data/Hest.clusters";
    static final String DEV_GOLDSTAND_PATH = "data/dev.gold_standards";
